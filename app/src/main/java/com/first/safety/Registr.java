...
public class Registr extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        b1.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                addData(sr);
                Toast.makeText(Registr.this,"Data added",Toast.LENGTH_SHORT).show();
                e1.setText("");
            }
        });
        ...
        b2.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                DeleteData(x);
                Toast.makeText( Registr.this,"DATA DELETED", Toast.LENGTH_SHORT).show();
            }
        });
    ...
    private void loadData() {
        ...
        if (data.getCount()==0){
            Toast.makeText( Registr.this,"There is no content",Toast.LENGTH_SHORT).show();
        }
    ...
    private void addData(String newEntry) {
        ...
        if (insertData){
            ...
            Toast.makeText( Registr.this,"Unsuccessfull",Toast.LENGTH_SHORT).show();
        }
